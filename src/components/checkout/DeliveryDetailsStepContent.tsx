...
const DeliveryDetailsStepContent: React.FC = () => {
  ...
  const handleContinue = async () => {
    try {
      ...
      if (user) {
        console.log(
          "✅ User is logged in - skipping validation and proceeding to save..."
        );
      } else {
      ...
      if (user && (orderForm.fullName.trim() || orderForm.email.trim())) {
        ...
        try {
          ...
          if (personalDetailsSuccess) {
            ...
            console.warn(
              "⚠️ Failed to save personal details, but continuing..."
            );
          }
        } catch (error) {
      ...
      if (
        ...
        try {
          ...
          if (!addressExists) {
            ...
            console.log(
              "ℹ️ Address already exists in address book, skipping save"
            );
          }
        } catch (error) {

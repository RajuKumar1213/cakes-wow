    ...
    <div className="relative bg-gradient-to-br from-pink-100 via-pink-50 to-rose-100  overflow-hidden">
      ...
      <div className="relative z-10">
        <section className="py-8 md:py-12">
          <div className="container mx-auto px-4 md:px-6 lg:px-8">            <h2 className="font-poppins text-2xl text-center md:text-left md:text-3xl font-semibold text-gray-800 mb-6">

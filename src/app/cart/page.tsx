          ...
          <div className="max-w-5xl mx-auto px-4">
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-12 text-center">
              <div className="relative mb-6 md:mb-8">
                {" "}
                <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-orange-100 to-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12 pt-6 md:pt-8 border-t border-gray-200">
                {trustFeatures.map((feature, index) => (
                  ...
                  >
                    {" "}
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-orange-600 rounded-full flex items-center justify-center mb-2 md:mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4">
              {trustFeatures.map((feature, index) => (
                <div key={index} className="flex items-center gap-2 md:gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-black text-xs md:text-sm">
                      {feature.title}
                    </h3>
            ...
            <div className="lg:col-span-2 space-y-3 md:space-y-4">
                                  ...
                                  {(item.customization.imageUrl ||
                                    item.customization.image) && (
                                      <Image
                                        src={
                                          item.customization.imageUrl ||
                                          (item.customization.image instanceof
                                            File
                                            ? URL.createObjectURL(
                                              item.customization.image
                                            )
                          ...
                          {item.selectedAddOns &&
                            item.selectedAddOns.length > 0 && (
                              <div className="mt-2 md:mt-3 p-2 md:p-3 bg-orange-50 rounded border-l-4 border-orange-200">
                                <h4 className="text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2">
                                  Selected Add-ons:
                                </h4>
              ...
              {selectedAddOns.length > 0 && (
                <div className="bg-white rounded shadow-xl overflow-hidden">
                  <div className="bg-orange-600 text-white p-3 md:p-4">
                    ...
                    <p className="text-orange-100 mt-1 text-xs md:text-sm">
                      Extra special touches for your order
                    </p>
                  </div>{" "}
                  <div className="p-2 md:p-3">
                    <div className="space-y-1.5 md:space-y-2">
                      {selectedAddOns.map((addOn) => (
                        <div
                          key={addOn._id}
                          className="flex items-center justify-between p-1.5 md:p-2 bg-orange-50 rounded border border-orange-200"
                        >
              ...
              <div className="bg-white rounded shadow-xl overflow-hidden">
                <div className="bg-gradient-to-r from-pink-600 to-orange-600 text-white p-3 md:p-4">
                  ...
                  <p className="text-pink-100 mt-1 text-xs md:text-sm">
                    Make your order extra special with these add-ons
                  </p>
                </div>
                ...
                <div className="p-4">
                  <div className="space-y-3 mb-4">
                    ...
                    {selectedAddOns.length > 0 && (
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 text-sm">
                          Add-ons ({selectedAddOns.length} items)
                        </span>
                        <span className="font-semibold text-sm">
                  ...
                  <div className="space-y-2 mb-4">
                    <Button
                      ...
                      className="w-full bg-orange-600 hover:bg-orange-700 text-white py-3 text-base rounded"
                    >
                      Proceed to Checkout
                    </Button>
                    ...
                    <Link href="/">
                      <Button
                        variant="outline"
                        className="w-full py-2 rounded border-gray-300 hover:bg-gray-50 text-sm"
                      >
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-3 md:p-4 lg:hidden z-50">
            <div className="flex items-center justify-between gap-3">
              ...
              <Button
                ...
                className="flex-shrink-0 bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 text-sm md:text-base rounded-lg"
              >
                Checkout
              </Button>
            </div>

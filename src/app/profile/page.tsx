...
export default function ProfilePage() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await fetch(`/api/orders?mobile=${encodeURIComponent(user.phoneNumber)}`, {
        method: 'GET',
        headers: {
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100 mb-8 overflow-hidden">
          <div className="flex border-b border-gray-100">
            <button
              ...
              className={`flex-1 px-4 md:px-6 py-4 text-sm font-medium transition-colors ${activeTab === 'overview'
            ...
            <button
              ...
              className={`flex-1 px-4 md:px-6 py-4 text-sm font-medium transition-colors ${activeTab === 'orders'
                  ? 'bg-pink-50 text-pink-600 border-b-2 border-pink-500'
                  : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'
                }`}
            >
            ...
            <button
              ...
              className={`flex-1 px-4 md:px-6 py-4 text-sm font-medium transition-colors ${activeTab === 'settings'
                  ? 'bg-pink-50 text-pink-600 border-b-2 border-pink-500'
                  : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'
                }`}
            >
